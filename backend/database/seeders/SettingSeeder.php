...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['loyalty', 'loyalty_enabled', 'true', 'boolean', false],
            ['loyalty', 'loyalty_points_per_currency', '1', 'float', false],
            ['loyalty', 'loyalty_point_value', '0.01', 'float', false],
            ['loyalty', 'loyalty_minimum_redemption_points', '100', 'integer', false],
